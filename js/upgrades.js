...
Upgrades.prestigeUpgrades = [
  ...
  new Upgrades.Upgrade(115, "Insidious Plague", Upgrades.types.insidiousPlague, Upgrades.costs.prestigePoints, 2500, 1, 1, 1, "Reduces plague damage over time by 90%, but makes it incurable, so it lasts forever."),
  new Upgrades.Upgrade(116, "Bone Boom", Upgrades.types.boneBoom, Upgrades.costs.prestigePoints, 10000, 1, 1, 1, "Automatically destroys all zombies before each level ends, turning them into bones and brains."),
  new Upgrades.Upgrade(117, "Advanced Time Warp", Upgrades.types.unlockSpell, Upgrades.costs.prestigePoints, 1000000, 1, 6, 1, "Uses all energy, and warps more powerfully and for longer, based on the energy you have when you cast it."),
...
Upgrades.upgrades = [
  ...
  new Upgrades.Upgrade(7, "Detonate", Upgrades.types.unlockSpell, Upgrades.costs.blood, 25000, 1, 3, 1, "Learn the Detonate spell which can explode all of your zombies into a cloud of plague. Not exactly sure how useful that will be.", "Detonate has been added to your spellbook", 209),
  new Upgrades.Upgrade(8, "Gigazombies?", Upgrades.types.unlockSpell, Upgrades.costs.blood, 50000, 1, 5, 1, "Learn the Gigazombies spell which will turn some of your zombies into hulking monstrosities with increased health and damage.", "The Gigazombies spell has been added to your spellbook", 209),
  ...
  new Upgrades.Upgrade(26, "Energy Charge", Upgrades.types.unlockSpell, Upgrades.costs.brains, 2000, 1, 2, 1, "Learn the Energy Charge spell which can drastically increase your energy rate for a short time.", "The Energy Charge spell has been added to your spellbook", 209),
  ...
  new Upgrades.Upgrade(45, "Earth Freeze", Upgrades.types.unlockSpell, Upgrades.costs.bones, 5000, 1, 4, 1, "Learn the Earth Freeze spell which can freeze all humans in place for a short time.", "Earth Freeze has been added to your spellbook", 209),
  new Upgrades.Upgrade(46, "Plague Armor", Upgrades.types.plagueArmor, Upgrades.costs.bones, 15000, 1.6, 0.02, 10, "The best defense is a good offense! Especially true in the case of Plague Armor, which reduces the damage done by infected humans 2% per rank.", false, 218),
